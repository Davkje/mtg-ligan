...
import { computeAchievements, placementsChronological } from "@/lib/achievements";
...
export default async function PlayerPage({ params }: { params: Promise<{ id: string }> }) {
	...
	const placements = placementsChronological(results);
	const achievements = computeAchievements(placements);
